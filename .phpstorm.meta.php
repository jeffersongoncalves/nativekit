...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','nativekit.theme_mode','nativekit.guest_panel_enabled',
'nativekit.admin_panel_enabled','nativekit.app_panel_enabled','nativekit.favicon.enabled','nativekit.favicon.manifest.name','nativekit.favicon.logo',
'nativekit.favicon.favicon','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\jeffersongoncalves\\nativekit\\public\\storage','logging.default',
